...
pkg_postinst() {
	elog "This plugin needs a trojan-go binary at runtime, which is not packaged"
	elog "in ::gentoo or ::guru. Install one manually (e.g. from upstream releases)"
	elog "and point Qv2ray to it in the plugin kernel settings."
}
